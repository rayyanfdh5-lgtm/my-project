...
<div class="space-y-6">
    ...
    {{-- Form --}}
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <form action="{{ route('admin.outgoing.store') }}" method="POST">
            @csrf
            ...
            <div class="px-6 py-6 space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6">
                        ...
                        <select name="user_select" id="user_select" required 
                            ...
                            @foreach($users as $user)
                                <option value="{{ $user->id }}" 
                                        ...
                                        {{ old('user_select') == $user->id ? 'selected' : '' }}>
                    ...
                    <input type="hidden" name="user_id_input" id="user_id_input" value="{{ old('user_id_input') }}">
