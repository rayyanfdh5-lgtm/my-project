<?php $__env->startSection('content'); ?>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">
            ...
            <div class="relative p-6">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <dd class="text-3xl font-bold text-gray-900"><?php echo e(number_format($totalActivities)); ?></dd>
            ...
            <div class="relative p-6">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <dd class="text-3xl font-bold text-gray-900"><?php echo e(number_format($todayActivities)); ?></dd>
            ...
            <div class="relative p-6">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <dd class="text-3xl font-bold text-gray-900"><?php echo e(number_format($thisWeekActivities)); ?></dd>
            ...
            <div class="relative p-6">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <dd class="text-3xl font-bold text-gray-900"><?php echo e(number_format($thisMonthActivities)); ?></dd>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
        ...
        <div class="p-6">
            <form method="GET" action="<?php echo e(route('admin.activities.index')); ?>" class="space-y-4">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <a href="<?php echo e(route('admin.activities.index')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md text-gray-700 bg-white hover:bg-gray-50 transition-colors">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500"><?php echo e($activities->total()); ?> total activities found</p>
                </div>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex items-start space-x-4">
                            <img class="h-10 w-10 rounded-full object-cover border-2 border-gray-200" 
                                src="<?php echo e($activity->user->profil ? asset($activity->user->profil) : 'https://ui-avatars.com/api/?name=' . urlencode($activity->user->name) . '&color=7F9CF5&background=EBF4FF&size=40'); ?>"
                                alt="<?php echo e($activity->user->name); ?>"
                                onerror="this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode($activity->user->name)); ?>&color=7F9CF5&background=EBF4FF&size=40'">
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center space-x-2">
                                    <p class="text-sm font-medium text-gray-900 truncate"><?php echo e($activity->user->name); ?></p>
                                    <?php if(($activity->user->role->value ?? 'user') === 'admin'): ?>
                                ...
                                <p class="text-sm text-gray-500 truncate"><?php echo e($activity->user->email); ?></p>
                                <div class="mt-1 flex items-center text-xs text-gray-500">
                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                    </svg>
                                    <?php echo e($activity->logged_in_at->format('d M Y, H:i:s')); ?>

                                    <span class="mx-2">•</span>
                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <?php echo e($activity->logged_in_at->diffForHumans()); ?>
                        ...
                        <div class="flex flex-col items-end space-y-1">
                            ...
                            <span class="text-xs text-gray-500">
                                <?php echo e($activity->logged_in_at->format('H:i')); ?>
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\artilia-main\resources\views/admin/contents/activities/index.blade.php ENDPATH**/ ?>