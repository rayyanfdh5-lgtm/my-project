...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin.components.partials.heading-section','data' => ['title' => 'User Management','subtitle' => 'Manage all user accounts and permissions']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'User Management','subtitle' => 'Manage all user accounts and permissions']); ?>
...
<?php endif; ?>
        ...
        <div class="mb-6 rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
            <form method="GET" action="<?php echo e(route('admin.content.listusers')); ?>" class="space-y-4">
        ...
        <div class="mb-4 flex items-center justify-between">
            ...
            <div class="text-sm text-gray-600">
                Total: <?php echo e($users->total()); ?> users
            </div>
        </div>

        <div class="overflow-x-auto rounded-xl border border-slate-200 bg-white shadow-md">
            <form id="bulk-form" action="<?php echo e(route('admin.content.bulkdeleteusers')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                    ...
                    <tbody class="tbody-next">
                        <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-slate-50 transition">
                                <td class="td-next">
                                    <input type="checkbox" name="user_ids[]" value="<?php echo e($user->id); ?>" class="user-checkbox rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                </td>

                                <td class="td-next">
                                    <div class="flex items-center gap-3">
                                        <img src="<?php echo e($user->profil ? asset($user->profil) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&color=7F9CF5&background=EBF4FF'); ?>"
                                            class="h-10 w-10 rounded-full object-cover border border-slate-200 shadow-sm"
                                            alt="Profile"
                                            onerror="this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode($user->name)); ?>&color=7F9CF5&background=EBF4FF'">
                                        <div>
                                            <div class="font-semibold text-slate-800"><?php echo e($user->name); ?></div>
                                ...
                                <td class="td-next">
                                    <?php if(($user->role->value ?? 'user') === 'admin'): ?>
                                ...
                                <td class="td-next text-sm text-gray-500"><?php echo e($user->email); ?></td>

                                <td class="td-next text-sm text-gray-500"><?php echo e($user->bio ?? 'No bio'); ?></td>

                                <td class="td-next">
                                    <div class="flex items-center space-x-2">
                                        <a href="<?php echo e(route('admin.content.showusers', $user->id)); ?>"
                                        ...
                                        <a href="<?php echo e(route('admin.content.editusers', $user->id)); ?>"
                                        ...
                                        <form action="<?php echo e(route('admin.content.togglestatususers', $user->id)); ?>" method="POST" class="inline">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit"
                                        ...
                                        <button type="button"
                                            onclick="openModal('modal-<?php echo e($user->id); ?>')"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin.components.popup','data' => ['id' => 'modal-'.e($user->id).'','title' => 'Delete User','message' => 'Are you sure want to delete this user? All data will be permanently removed.','formId' => 'delete-form-'.e($user->id).'','confirmText' => 'Delete','confirmClass' => 'text-sm link-primary delete-btn-color','cancelText' => 'Cancel']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-'.e($user->id).'','title' => 'Delete User','message' => 'Are you sure want to delete this user? All data will be permanently removed.','formId' => 'delete-form-'.e($user->id).'','confirmText' => 'Delete','confirmClass' => 'text-sm link-primary delete-btn-color','cancelText' => 'Cancel']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <form id="delete-form-<?php echo e($user->id); ?>" action="<?php echo e(route('admin.content.deleteusers', $user->id)); ?>" method="POST" style="display: none;">
            <?php echo csrf_field(); ?>
    ...
    <?php if (isset($component)) { $__componentOriginaleb8c89a7efda50450a3a76fb82e931fd = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaleb8c89a7efda50450a3a76fb82e931fd = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin.components.popup','data' => ['id' => 'bulk-delete-modal','title' => 'Delete Selected Users','message' => 'Are you sure you want to delete the selected users? All data will be permanently removed and cannot be recovered.','formId' => 'bulk-form','confirmText' => 'Delete Selected','confirmClass' => 'text-sm link-primary delete-btn-color','cancelText' => 'Cancel']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('popup'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'bulk-delete-modal','title' => 'Delete Selected Users','message' => 'Are you sure you want to delete the selected users? All data will be permanently removed and cannot be recovered.','formId' => 'bulk-form','confirmText' => 'Delete Selected','confirmClass' => 'text-sm link-primary delete-btn-color','cancelText' => 'Cancel']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginaleb8c89a7efda50450a3a76fb82e931fd)): ?>
<?php $attributes = $__attributesOriginaleb8c89a7efda50450a3a76fb82e931fd; ?>
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\artilia-main\resources\views/admin/contents/user/ListUsers.blade.php ENDPATH**/ ?>