<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <a href="<?php echo e(route('admin.borrowings.create')); ?>" 
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div class="px-6 py-4">
            <form method="GET" action="<?php echo e(route('admin.borrowings.index')); ?>" class="space-y-4">
                ...
                <div class="flex space-x-2">
                    ...
                    <a href="<?php echo e(route('admin.borrowings.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-100 hover:bg-gray-200 border border-gray-300 rounded-lg font-medium text-sm text-gray-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors duration-200">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $borrowings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $borrowing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <div class="font-medium"><?php echo e($borrowing->tanggal_kembali_rencana->format('d/m/Y')); ?></div>
                                    <?php
                                        $isOverdue = $borrowing->tanggal_kembali_rencana->isPast();
                                        $daysLeft = $borrowing->tanggal_kembali_rencana->diffInDays(now(), false);
                                    ?>
                                    <?php if($isOverdue): ?>
                                        <div class="text-xs text-red-600 font-medium">Terlambat <?php echo e(abs($daysLeft)); ?> hari</div>
                                    <?php else: ?>
                                        <div class="text-xs text-green-600"><?php echo e($daysLeft); ?> hari lagi</div>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    ...
                                    <form action="<?php echo e(route('admin.borrowings.return', $borrowing)); ?>" method="POST" class="inline">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <a href="<?php echo e(route('admin.borrowings.edit', $borrowing)); ?>" class="text-indigo-600 hover:text-indigo-900">Edit</a>
        ...
        <?php else: ?>
            <div class="px-6 py-12 text-center">
                ...
                <div class="mt-6">
                    <a href="<?php echo e(route('admin.borrowings.create')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                        </svg>
                        Tambah Peminjaman
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\artilia-main\resources\views/admin/contents/borrowings/index.blade.php ENDPATH**/ ?>