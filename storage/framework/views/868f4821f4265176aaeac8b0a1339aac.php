    ...
    <div class="sidebar-container w-64 bg-white fixed top-0 left-0 z-50 shadow-xl border-r border-gray-200">
        ...
        <nav class="sidebar-navigation px-4 py-6 space-y-1">
            ...
            <a href="<?php echo e(route('user.dashboard')); ?>"
               class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors <?php echo e(Route::is('user.dashboard') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50'); ?>">
                <svg class="w-5 h-5 mr-3 <?php echo e(Route::is('user.dashboard') ? 'text-blue-600' : 'text-gray-400'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="mt-4">
                ...
                <div x-show="borrowingOpen" x-collapse class="mt-1 ml-4 space-y-1">
                    <a href="<?php echo e(route('user.borrowing.index')); ?>"
                       class="flex items-center px-3 py-2 text-sm rounded-lg <?php echo e(Route::is('user.borrowing.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50'); ?>">
                        <svg class="w-4 h-4 mr-2 <?php echo e(Route::is('user.borrowing.*') ? 'text-blue-600' : 'text-gray-400'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/>
                        </svg>
                        Peminjaman Barang
                    </a>
            ...
            <div class="pt-4">
                <a href="<?php echo e(route('user.profile.index')); ?>"
                   class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors <?php echo e(Route::is('user.profile.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50'); ?>">
                    <svg class="w-5 h-5 mr-3 <?php echo e(Route::is('user.profile.*') ? 'text-blue-600' : 'text-gray-400'); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<?php /**PATH C:\laragon\www\artilia-main\resources\views/user/components/sidebar-user.blade.php ENDPATH**/ ?>