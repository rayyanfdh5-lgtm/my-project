        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl font-bold text-gray-900 flex items-center">
                    ...
                    Edit Kategori: <?php echo e($category->name); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   class="block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select id="status" 
                                    name="status" 
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm <?php $__errorArgs = ['status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="active" <?php echo e(old('status', $category->status) == 'active' ? 'selected' : ''); ?>>Aktif</option>
                                <option value="inactive" <?php echo e(old('status', $category->status) == 'inactive' ? 'selected' : ''); ?>>Tidak Aktif</option>
                            </select>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                  name="description" 
                                  rows="4" 
                                  class="block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                  placeholder="Jelaskan apa yang termasuk dalam kategori ini (opsional)&#10;Contoh: Kategori Elektronik mencakup smartphone, laptop, aksesoris, dan perangkat elektronik lainnya."><?php echo e(old('description', $category->description)); ?></textarea>
                ...
                <div class="bg-blue-50 rounded-lg p-4 border border-blue-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p class="text-sm text-blue-900 font-medium"><?php echo e($category->name); ?></p>
                        </div>
                        <div>
                            <p class="text-xs font-medium text-blue-600 uppercase tracking-wide">Status Saat Ini</p>
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($category->status == 'active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                    ...
                    <?php if($category->description): ?>
                        <div class="mt-4">
                            ...
                            <p class="text-sm text-blue-900"><?php echo e($category->description); ?></p>
                        </div>
                    <?php endif; ?>
                    
                    <div class="mt-4">
                        <p class="text-xs font-medium text-blue-600 uppercase tracking-wide">Jumlah Item</p>
                        <p class="text-sm text-blue-900 font-medium"><?php echo e($category->items->count()); ?> item</p>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\artilia-main\resources\views/admin/contents/categories/edit.blade.php ENDPATH**/ ?>