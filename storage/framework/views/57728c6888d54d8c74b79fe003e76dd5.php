...
<div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl font-bold text-gray-900 flex items-center">
                    ...
                    Edit Supplier: <?php echo e($supplier->company_name); ?>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <!-- Form Content -->
        <div class="p-6">
            <form action="<?php echo e(route('admin.suppliers.update', $supplier)); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="nama" 
                                   name="nama" 
                                   value="<?php echo e(old('nama', $supplier->nama)); ?>" 
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="active" <?php echo e(old('status', $supplier->status) == 'active' ? 'selected' : ''); ?>>Aktif</option>
                                <option value="inactive" <?php echo e(old('status', $supplier->status) == 'inactive' ? 'selected' : ''); ?>>Tidak Aktif</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" 
                                  placeholder="Masukkan alamat lengkap perusahaan"><?php echo e(old('address', $supplier->address)); ?></textarea>
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\artilia-main\resources\views/admin/contents/suppliers/edit.blade.php ENDPATH**/ ?>