<?php $__env->startSection('title', 'Kelola Permintaan Peminjaman'); ?>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow duration-200">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900"><?php echo e($completedCount); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200 <?php echo e($request->status === 'pending' ? 'bg-yellow-50 border-l-4 border-yellow-400' : ''); ?>">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center mr-3">
                                                <span class="text-xs font-bold text-blue-600">#<?php echo e($request->id); ?></span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="w-10 h-10 bg-gradient-to-r from-blue-400 to-blue-600 rounded-full flex items-center justify-center mr-3">
                                                <span class="text-white font-bold text-sm"><?php echo e(substr($request->user->name, 0, 1)); ?></span>
                                            </div>
                                            <div>
                                                <div class="text-sm font-semibold text-gray-900"><?php echo e($request->user->name); ?></div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <div class="text-sm font-semibold text-gray-900"><?php echo e($request->item->nama); ?></div>
                                                <div class="text-xs text-gray-500"><?php echo e($request->item->supplier->nama ?? 'N/A'); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center text-sm text-gray-900">
                                            ...
                                            <?php echo e($request->tanggal_kembali_rencana->format('d/m/Y')); ?>
                                                ...
                                                <div class="flex flex-col">
                                                    ...
                                                    <?php if($request->completed_at): ?>
                                                        <div class="text-xs text-gray-500 ml-5">
                                                            ...
                                                            <?php echo e($request->completed_at->format('d/m/Y H:i:s')); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center text-sm text-gray-900">
                                            ...
                                            <div>
                                                <div class="font-semibold"><?php echo e($request->created_at->format('d/m/Y')); ?></div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center space-x-2">
                                            <!-- View Button -->
                                            <a href="<?php echo e(route('admin.borrowing-requests.show', $request->id)); ?>" 
                                            ...
                                            <?php if($request->status === 'pending'): ?>
                                                ...
                                                <button type="button" 
                                                        ...
                                                        onclick="openApproveModal(<?php echo e($request->id); ?>, '<?php echo e($request->user->name); ?>', '<?php echo e($request->item->nama); ?>')">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                                    </svg>
                                                ...
                                                <button type="button" 
                                                        ...
                                                        onclick="openRejectModal(<?php echo e($request->id); ?>, '<?php echo e($request->user->name); ?>', '<?php echo e($request->item->nama); ?>')">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                                                    </svg>
                                            ...
                                            <?php elseif($request->status === 'approved'): ?>
                                                <!-- Complete Button -->
                                                <form action="<?php echo e(route('admin.borrowing-requests.complete', $request->id)); ?>" 
                                                      method="POST" 
                                                      class="inline"
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\artilia-main\resources\views/admin/contents/borrowing-requests/index.blade.php ENDPATH**/ ?>