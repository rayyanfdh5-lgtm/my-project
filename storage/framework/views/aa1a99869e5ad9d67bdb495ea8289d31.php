...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="rounded-xl border border-red-200 bg-red-50 shadow-sm">
                ...
                <form action="<?php echo e(route('admin.profile.destroy')); ?>" method="POST" class="p-6">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\artilia-main\resources\views/admin/pages/profile.blade.php ENDPATH**/ ?>