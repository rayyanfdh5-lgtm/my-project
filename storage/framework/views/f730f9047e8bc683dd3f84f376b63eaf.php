...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex justify-between items-center">
            ...
            <a href="<?php echo e(route('user.borrowing.my-requests')); ?>" 
                        ...
                        <div class="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden">
                            ...
                            <div class="relative h-48 w-full overflow-hidden bg-gray-100">
                                ...
                                <div class="absolute top-3 right-3">
                                    <span class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full shadow-sm">
                                        <?php echo e($item->stok_peminjaman); ?> tersedia
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="p-6">
                                <div class="flex justify-between items-start mb-4">
                                    <h3 class="text-lg font-semibold text-gray-900 line-clamp-2"><?php echo e($item->nama); ?></h3>
                                </div>
                                
                                
                                <?php if($item->keterangan): ?>
                                    <p class="text-gray-600 text-sm mb-4 line-clamp-2"><?php echo e(Str::limit($item->keterangan, 100)); ?></p>
                                <?php endif; ?>
                                
                                <div class="flex space-x-2">
                                    <a href="<?php echo e(route('user.borrowing.show-item', $item->id)); ?>" 
                                    ...
                                    <a href="<?php echo e(route('user.borrowing.create', $item->id)); ?>" 
...
<?php echo $__env->make('user.layouts.dashboard-user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\artilia-main\resources\views/user/contents/borrowing/index.blade.php ENDPATH**/ ?>