        ...
        <div class="lg:col-span-1">
            <div class="rounded-lg border border-gray-200 bg-white p-6">
                ...
                <div class="flex flex-col items-center space-y-4">
                    <div class="relative">
                        <img src="<?php echo e($user->profil ? asset($user->profil) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&color=7F9CF5&background=EBF4FF&size=96'); ?>"
                            alt="<?php echo e($user->name); ?>"
                            class="h-24 w-24 rounded-full object-cover ring-4 ring-gray-100"
                            onerror="this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode($user->name)); ?>&color=7F9CF5&background=EBF4FF&size=96'"
                            id="profilePhoto">
                    ...
                    <div class="w-full space-y-4">
                        <form action="<?php echo e(route('user.profile.update-photo')); ?>" method="POST" enctype="multipart/form-data" id="photoForm">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="space-y-6 lg:col-span-2">
            ...
            <div class="rounded-lg border border-gray-200 bg-white">
                ...
                <form action="<?php echo e(route('user.profile.update-email')); ?>" method="POST" class="space-y-6 p-6">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PATCH'); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="rounded-lg border border-gray-200 bg-white">
                ...
                <form action="<?php echo e(route('user.profile.update-password')); ?>" method="POST" class="space-y-6 p-6">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PATCH'); ?>
...
<?php echo $__env->make('user.layouts.dashboard-user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\artilia-main\resources\views/user/profile/index.blade.php ENDPATH**/ ?>